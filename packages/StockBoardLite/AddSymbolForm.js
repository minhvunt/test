Stock.AddSymbolForm = AV.extend(AV.Module, {
	...
	buy: function(symbol)
	{
		...
		//AV.alert('Buy symbol: '+symbol+'; Price: '+Stock.currentPrice+'; Floor: '+Stock.floor+' (Sua o trong ham /packages/StockBoardLite/AddSymbolForm.js - buy())');
	},
	sell: function(symbol)
	{
		parent.Order_Buy_QuickOrder('Sell', symbol, Stock.floor);
		//AV.alert('Sell symbol: '+symbol+'; Price: '+Stock.currentPrice+'; Floor: '+Stock.floor+' (Sua o trong ham /packages/StockBoardLite/AddSymbolForm.js - sell())');
	}
});