			...
			if(!!SOAPClient.Proxy) {
				...
				function getResponse(xData) {
					...
					if(typeof(callback) === "function") {
						if(xData.firstChild.firstChild.firstChild.firstChild.firstChild.tagName)
						{
							var jsOut = AV.xmlToJson($(xData.firstChild.firstChild.firstChild.firstChild));
						}
						else
						{
							var jsOut = $(xData.firstChild.firstChild.firstChild).text();
						}
						callback(jsOut);
					}
				}
